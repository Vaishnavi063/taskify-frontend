        ...
        <SidebarMenuItem>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <SidebarMenuButton
                size="lg"
                className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground hover:bg-muted/50 border focus:outline-none focus-visible:ring-0"
              >
            ...
            >
              ...
              <DropdownMenuItem className="gap-1 p-2 flex flex-col mb-2 items-start cursor-pointer bg-muted/50">
